...
public class PropertyListingFrame extends JFrame {
    private JTextField titleField, locationField, priceField;
    private JTextArea descriptionArea;
    private JComboBox<String> typeComboBox;

    public PropertyListingFrame(int ownerId) {
        setTitle("List a Property");
        setSize(400, 400);
    ...
    public static void main(String[] args) {
        // Example ownerId, you might want to replace this with actual user ID from login
        int ownerId = 1; 
        new PropertyListingFrame(ownerId);
    }
}
